...
% pixel during the \SI{3e-3}{\second} the gate is open. The number of background
% photons that hits a pixel is a discrete value, and so is also generated by
% generating a Poisson random number.  As discussed later in
