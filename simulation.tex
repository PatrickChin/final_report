...
amplifying all previously added backgrounds. This was simulated by simply
scaling the value of the bin, along with it's error, by this value rather than
...
process, however the overall effect remains accurate. Despite this, the error
arrising from this process is likely to scale the error as mentioned.
